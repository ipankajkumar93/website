...
A clean, minimal, and fast boilerplate template for personal websites and blogs.
...
<p align="center">
  ...
  <a href="https://example.com"><img src="https://img.shields.io/badge/Website-UP-success?style=for-the-badge" alt="Website Status"></a>
...
```bash
# Clone the repo
git clone https://github.com/johndoe/zola-slate.git
cd zola-slate
