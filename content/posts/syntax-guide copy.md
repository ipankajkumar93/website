+++
draft = false
slug = "post-syntax-guide-copy" # Overrides the URL path for this page (e.g. /posts/syntax-guide/)
...
#!/bin/bash
echo "Hello, world!"
BACKUP_PATHS=("/mnt/storage" "/home/user/stacks")
...
[Visit my GitHub profile](https://github.com/johndoe)
