...
AI is not here to turn developers into people who are simply good at writing polite English prompts, no matter how badly the AI industry wants to sell that story. And they *do* want to sell it - every AI company right now has a vested interest in convincing the market that software development as we know it is over, that agents and prompts and loops are the entire future, that `SDLC` is a relic. It's a good pitch if you're trying to be indispensable for the next decade. Companies chasing every sector at once, launching a new **AI for this and that** product every week, aren't doing that because the technology or the market demands it - they're doing it so that when the hype eventually cools and settles down, they're not left irrelevant in a single market they never diversified out of.
